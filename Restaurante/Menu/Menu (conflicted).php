...
<body >
    ...
    <div class="menu">
      <button class="button" data-target="#Desayuno" name="slider">Desayuno</button>
...
// para mostrar titulo y descripcion el cual de forma busca un poer para que lo convierta  a pover 
      ...
      <div data-content id="Comida">
        ...
        <div class="row ">
      <?php 
      $sentencia=$pdo->prepare("SELECT * FROM `Comida`");
      $sentencia->execute();
      $listaProducto=$sentencia->fetchAll(PDO::FETCH_ASSOC);
      // print_r($listaProducto);
      ?>
...
// para mostrar titulo y descripcion el cual de forma busca un poer para que lo convierta  a pover 
      ...
      <div data-content id="Cena">
        <h1>Cena</h1>
        <?php 
      $sentencia=$pdo->prepare("SELECT * FROM `cena`");
      $sentencia->execute();
      $listaProducto=$sentencia->fetchAll(PDO::FETCH_ASSOC);
      // print_r($listaProducto);
      ?>
...
// para mostrar titulo y descripcion el cual de forma busca un poer para que lo convierta  a pover 
    ...
    <div data-content id="Postre">
        <h1>Postre</h1>
        <?php 
      $sentencia=$pdo->prepare("SELECT * FROM `Postre`");
      $sentencia->execute();
      $listaProducto=$sentencia->fetchAll(PDO::FETCH_ASSOC);
      // print_r($listaProducto);
      ?>
...
// para mostrar titulo y descripcion el cual de forma busca un poer para que lo convierta  a pover 
    ...
    <div data-content id="Tradicional">
        <h1>Tradicional</h1>
        <?php 
      $sentencia=$pdo->prepare("SELECT * FROM `Tradicional  `");
      $sentencia->execute();
      $listaProducto=$sentencia->fetchAll(PDO::FETCH_ASSOC);
      // print_r($listaProducto);
      ?>
